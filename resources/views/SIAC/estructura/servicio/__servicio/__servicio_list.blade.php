            ...
            <table  id="tblCat" class="table table-bordered table-striped dt-responsive wrap dataTable w-100-percent" role="grid" aria-describedby="datatable-buttons_info">
                <thead>
                    <tr role="row">
                        ...
                        <th class="sorting w-8-percent">Prom Aten</th>
                        <th class="sorting w-8-percent">Prom Rech</th>
                ...
                @foreach($items as $item)
                    <tr>
                        ...
                        <td>{{round($item->promedio_dias_atendida, 2)}}</td>
                        <td>{{round($item->promedio_dias_rechazada, 2)}}</td>
                        <td class="text-center">

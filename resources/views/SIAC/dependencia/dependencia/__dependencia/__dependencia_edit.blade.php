...
<div class="form-group row mb-1">
    <label for = "abreviatura" class="col-md-3 col-form-label has-abreviatura float-right">Abreviatura</label>
    <div class="col-md-3">
    ...
    <label for = "class_css" class="col-md-3 col-form-label float-right">Clase CSS</label>
    <div class="col-md-3">
        <input type="text" name="class_css" id="class_css" value="{{ old('class_css',$items->class_css) }}" class="form-control" />
    </div>
</div>
<div class="form-group row mb-1">
    <label for = "visible_internet" class="col-md-3 col-form-label float-right">Visible en Internet</label>
    <div class="col-md-3">
...
<div class="form-group row mb-1">
    ...
    <label for = "estatus_cve" class="col-md-3 col-form-label">Activo</label>
    <div class="col-md-3">
        <select class=" form-control "  name="estatus_cve" id="estatus_cve" size="1">
            @foreach($estatus_cve as $id => $valor)
                <option value="{{ $id }}" @if($id === $items->estatus_cve) selected @endif>{{ $valor }}</option>
            @endforeach
        </select>
    </div>
</div>

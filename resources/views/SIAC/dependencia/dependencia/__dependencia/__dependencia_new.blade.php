...
<div class="form-group row mb-1">
    ...
    <div class="col-md-3">
        <select class=" form-control select2"  name="ambito_dependencia" id="ambito_dependencia" size="1">
    ...
    <div class="col-md-3">
        <select class=" form-control select2"  name="estatus_cve" id="estatus_cve" size="1">

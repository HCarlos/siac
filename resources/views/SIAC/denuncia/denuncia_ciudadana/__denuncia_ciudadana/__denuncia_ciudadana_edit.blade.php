    ...
    <div class="col-md-6 ">
        <div class="grid-container">
            <div class="form-row mb-1">
                ...
                <div class="col-md-4">
                    <input type="date" name="fecha_ingreso" id="fecha_ingreso" value="{{ $items->fecha_ingreso }}" class="form-control" readonly>
                </div>
                <label for = "fecha_oficio_dependencia" class="col-md-2 col-form-label">F. Oficio </label>
                <div class="col-md-4">
                    <input type="date" name="fecha_oficio_dependencia" id="fecha_oficio_dependencia" value="{{ $items->fecha_oficio_dependencia }}" class="form-control">
                </div>
            </div>
            <div class="form-row mb-1">
                <label for = "fecha_ejecucion" class="col-md-2 col-form-label">F. Ejec. </label>
                <div class="col-md-4">
                    <input type="date" name="fecha_ejecucion" id="fecha_ejecucion" value="{{ $items->fecha_ejecucion }}" class="form-control" readonly>
                </div>
                <label for = "fecha_limite" class="col-md-2 col-form-label">F. Límite </label>
                <div class="col-md-4">
                    <input type="date" name="fecha_limite" id="fecha_limite" value="{{ $items->fecha_limite }}" class="form-control" readonly>
                </div>
            </div>
            <div class="form-row mb-1">
            ...
            <div class="form-group row mb-1">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <input type="text" name="search_autocomplete" id="search_autocomplete" value="" placeholder="Buscar ubicación..." class="form-control">

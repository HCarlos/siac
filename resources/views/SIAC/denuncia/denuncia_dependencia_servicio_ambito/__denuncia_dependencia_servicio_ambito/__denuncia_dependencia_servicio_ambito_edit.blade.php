...
{{--                            <option value="{{$t->id}}" {{ $t->id == $items->servicio_id  ? 'selected': '' }} >{{ $t->servicio }} </option>--}}
            ...
            <div class="form-group row mb-1">
                ...
                <div class="col-md-9">
                    <textarea id="observaciones" name="observaciones" class="form-control {{$errors->has('observaciones')?'has-error form-error':''}}" cols="10" rows="4" spellcheck="true" lang="es" >{{$items->observaciones}}</textarea>
            ...
            <div class="form-group row mb-1">
                ...
                <div class="col-md-5">
{{--                    <input type="datetime" id="fecha_movimiento" name="fecha_movimiento" value="{{ $items->fecha_movimiento }}" class="form-control w-100-percent" >--}}
                    <input
                        type="datetime-local"
                        id="fecha_movimiento"
                        name="fecha_movimiento"
                        value="{{ $items->fecha_movimiento->format('Y-m-d\TH:i:s') }}"

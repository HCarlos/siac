    ...
    <div class="col-lg-6 ">
        <div class="grid-container">
            ...
            <div class="form-row mb-1">
                ...
                <div class="col-lg-10">
                    <small class="text-default font-medium text-center p-0 m-0" id="searchGoogleResult"></small>
                </div>
            </div>
            ...
            <div class="form-group row mb-1">
                ...
                <div class="col-lg-12">
                    <textarea name="referencia" id="referencia" rows="5" class="form-control">{{ old('referencia') }}</textarea>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <select id="servicio_id" name="servicio_id" class="form-control" size="1">
                        @foreach($servicios as $t)
                            <option value="{{$t->id}}" >{{  $t->id }} - {{ $t->servicio.' ('.$t->abreviatura_dependencia.')'  }} </option>
                        @endforeach
                    </select>
                </div>
            </div>

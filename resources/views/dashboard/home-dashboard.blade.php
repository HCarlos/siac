                        ...
                        <div class="col-12 col-sm-6 col-lg-3 px-2 mb-2 mb-lg-0">
                            <div class="bcard h-100 d-flex align-items-center p-3">
                                ...
                                <div class="ml-3 flex-grow-1">
                                    ...
                                    <div class="task-item mb-25 radius-3px bgc-secondary-l4 mt-1 pt-2 pb-2 pos-rel">
                                        <div class="progress position-bl w-100 h-auto">
                                            <div class="progress-bar bgc-success progress-bar-striped progress-bar-animated"
                                                 role="progressbar" style="height: 6px; width: {{ $PorcResuelto }}%;"
                                                 aria-valuenow="{{ $PorcResuelto }}" aria-valuemin="0"
                                    ...
                                    <div class="task-item mb-25 radius-3px bgc-secondary-l4 mt-1 pt-2 pb-2 pos-rel">
                                        <div class="progress position-bl w-100 h-auto">
                                            <div class="progress-bar bgc-danger progress-bar-striped progress-bar-animated"
                                                 role="progressbar" style="height: 6px; width: {{ $PorcNoResuelto }}%;"
                                                 aria-valuenow="{{ $PorcNoResuelto }}" aria-valuemin="0"
                                                 aria-valuemax="100"></div>
                                        </div>
                                        <div class="pl-1">
                                            <div>
                            ...
                            <div class="card-header border-0">
                                <div class="col-12 card-body p-3">
                                    ...
                                    @foreach($Top10Deps as $Dep)
                                        ...
                                        <div class="task-item mb-25 radius-3px bgc-secondary-l4 mt-1 pt-2 pb-2 pos-rel">
                                            <div class="progress position-bl w-100 h-auto">
                                                <div class="progress-bar bgc-{{$colors[$i++]}} progress-bar-striped progress-bar-animated"
                                                     role="progressbar" style="height: 6px; width: {{ $valorPorc }}%;"
                                                     aria-valuenow="{{ $valorPorc }}" aria-valuemin="0"
                                                     aria-valuemax="100"></div>
                                            </div>
                                            <div class="pl-1">
                                                <div>
                                                    {{ $Dep->dependencia->abreviatura }}:
                                                    <strong>{{ $Dep->cantidad_dependencia }}</strong>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach

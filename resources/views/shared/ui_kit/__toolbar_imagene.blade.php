...
<div class="button-list mt-md-2">
    @isset($newItem)
        ...
        <a href="{{route($newItem,['denuncia_id'=>$denuncia_id]) }}" id="{{$newItem}}" @isset($newWindow) target="_blank" @endisset class="btn btn-icon btn-outline-light btn-rounded  " data-toggle="tooltip" data-placement="top" title="" data-original-title="Nuev@" >
            <i class="fas fa-plus"></i>
        </a>

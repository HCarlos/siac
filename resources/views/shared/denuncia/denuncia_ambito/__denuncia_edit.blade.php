...
{{--                    {{ Form::date('fecha_oficio_dependencia', $items->fecha_oficio_dependencia, ['id'=>'fecha_oficio_dependencia','class'=>'form-control']) }}--}}
                    <input type="date" name="fecha_oficio_dependencia" id="fecha_oficio_dependencia" value="{{ \Carbon\Carbon::parse($items->fecha_oficio_dependencia,'Y-m-f') }}" class="form-control"  >
                </div>
            </div>
            <div class="form-row mb-1">
...
{{--                    {{ Form::date('fecha_ejecucion', $items->fecha_ejecucion, ['id'=>'fecha_ejecucion','class'=>'form-control','readonly'=>'readonly']) }}--}}
                    <input type="date" name="fecha_ejecucion" id="fecha_ejecucion" value="{{ \Carbon\Carbon::parse($items->fecha_ejecucion,'Y-m-f') }}" class="form-control" readonly >
                </div>
...
{{--                    {{ Form::date('fecha_limite', $items->fecha_limite, ['id'=>'fecha_limite','class'=>'form-control','readonly'=>'readonly']) }}--}}
                    <input type="date" name="fecha_limite" id="fecha_limite" value="{{ \Carbon\Carbon::parse($items->fecha_limite,'Y-m-f') }}" class="form-control" readonly >
                </div>
            </div>
            <div class="form-row mb-1">

...
@section('container')
    ...
    @component('components.asignacionesV3')
...
{{--            <select class="lstAsigns form-control asign-lstAsigns0" name="search_autocomplete_user" id="{{$urlRegresa}}" size="1">--}}
{{--                @foreach($lstSuper0 as $i=>$value)--}}
{{--                    <option value="{{ $i }}" >{{ $value }}</option>--}}
{{--                @endforeach--}}
{{--            </select>--}}

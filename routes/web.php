...
Route::group(['middleware' => 'auth'], static function () {
    ...
    // Dashboard General
    Route::match(['get','put','post'],'dashboard-statistics-general', 'Dashboard\DashboardSMGeneralController@index')->name('dashboard-statistics-general');

    // Dashboard Servicios Principales
    Route::match(['get','put','post'],'dashboard-statistics-servicios-principales', 'Dashboard\SMInicioController@index')->name('dashboard-statistics-servicios-principales');
...
//    Route::get('listDenunciasLocales/', 'Denuncia\DenunciaAmbitoController@indexLocales')->name('listDenunciasLocales');
    ...
    Route::post('repDelCiuInt1A', 'ExcelAutollenable\ReporteDelCiuInt\RepDelCiuInt1AController@repDelCiuInt1A')->name('repDelCiuInt1A');
...
Route::group(['middleware' => 'role:auth|Administrator|SysOp|DELEGADO|DELEGADOS|COORDINACION_DE_DELEGADOS|CIUDADANO|USER_OPERATOR_SIAC|USER_OPERATOR_ADMIN|ENLACE|USER_ARCHIVO_CAP|USER_ARCHIVO_ADMIN'], static function () {
    ...
    Route::post('lastDepDen', 'Denuncia\DenunciaDependenciaServicioAmbitoController@lastDepDen')->name('lastDepDen');
